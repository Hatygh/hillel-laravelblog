...
<div class="container">
    ...
    <form method="post" action="{{ route('users.store') }}">
        ...
        <div class="form-group row">
            <label for="password" class="col-sm-2 col-form-label text-success">Password confirmation</label>
            <div class="col-sm-7">
                <input type="password"
                       @if ($errors->has('password_confirmation')) class="form-control is-invalid"
                       @else class="form-control is-valid"
                       @endif
                       name="password_confirmation" placeholder="Password confirmation" value="{{ @old('password_confirmation')}}">
            </div>
